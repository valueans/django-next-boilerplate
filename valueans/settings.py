"""
Django settings for valueans project.
...
WSGI_APPLICATION = "valueans.wsgi.application"
...
if USE_S3:
    ...
    DEFAULT_FILE_STORAGE = env.str(
        "DEFAULT_FILE_STORAGE", "valueans.storage_backend.MediaStorage"
    )
